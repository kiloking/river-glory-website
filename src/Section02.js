  ...
  return (
    <div className=' w-full  relative'>
      ...
      <div className='aspect-[747/1200]  w-full  relative  z-0  lg:hidden overflow-x-scroll' ref={scrollContainerRef}> 
        <div className='top-0 absolute flex justify-center w-full px-10 py-12'><img src={process.env.PUBLIC_URL +'/images/release/section02_title.png'} alt="" className='max-w-full' /></div>
      ...
      //  style={{backgroundImage: `url(${process.env.PUBLIC_URL +'/images/release/section02_bg.png'})`}}
       >
        <div className='top-0 absolute flex justify-center w-full px-10 py-12'><img src={process.env.PUBLIC_URL +'/images/release/section02_title.png'} alt="" className='max-w-full' /></div>
        <img src={process.env.PUBLIC_URL +'/images/release/section02_bg.png'} alt="" className='w-full' />
      </div>
