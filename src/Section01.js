...
function Section01() {
  return (
    ...
    >
        <div className='flex gap-4 flex-col md:flex-row justify-between items-center w-10/12 mx-auto py-10 md:py-12'>
          <div className='md:w-1/3 '>
            <img src={process.env.PUBLIC_URL+'/images/release/section01_title.png'} alt="" className='max-w-full  w-[80%]'/>
          </div>
          <div className='md:w-2/3 relative ml-[18%] flex flex-col justify-end '>
        ...
        <div className=' absolute md:bottom-24 left-5 w-[22%]'>
